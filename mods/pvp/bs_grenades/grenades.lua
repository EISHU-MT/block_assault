...
grenades.register_grenade("grenades:flashbang", {
	...
	on_explode = function(def, obj, pos, name)
		for _, v in ipairs(minetest.get_objects_inside_radius(pos, 20)) do
			if v:is_player() and v:get_hp() > 0 and not flash_huds[v:get_player_name()] then
...
Shop.RegisterWeapon("Grenade", {
	item_name = "grenades:frag",
	price = 20,
	icon = "grenades_frag.png",
	type = "armor",
	count_limit = 5,
	stype = "grenade",
	uses_ammo = false,
})
Shop.RegisterWeapon("Grenade Sticky", {
	item_name = "grenades:frag_sticky",
	price = 25,
	icon = "grenades_frag_sticky.png",
	type = "armor",
	count_limit = 5,
	stype = "grenade",
	uses_ammo = false,
})
Shop.RegisterWeapon("Flashbang", {
	item_name = "grenades:flashbang",
	price = 50,
	icon = "grenades_flashbang.png",
	type = "armor",
	count_limit = 5,
	stype = "grenade",
	uses_ammo = false,
