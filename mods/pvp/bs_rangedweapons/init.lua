...
p_meta:set_int(skill, skill_num + 1)
    --minetest.chat_send_player(player:get_player_name(), "" ..core.colorize("#25c200","You've improved your skill with this type of gun!"))-- DISABLE
end
end
...
rangedweapons.delays[Name(player)] = gun_reload or 0.2 -- Prevent use of meta
...
if inv:contains_item("main",reload_ammo:get_name().." "..clipSize) then
	...
	rangedweapons.bullets[Name(player)] = clipSize --gunMeta:set_int("RW_bullets",clipSize)
else
...
--itemstack:add_wear(65535/gun_durability) --  No. why: no.
end
