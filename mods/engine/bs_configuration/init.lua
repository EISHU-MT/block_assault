...
local EnableBots = GetBoolean("EnableBots", true)
...
local ReCheckAliveBots = GetBoolean("ReCheckAliveBots", true)
...
local ForceUseOfTraditionalNametags = GetBoolean("ForceUseOfTraditionalNametags", false)
...
config.ReCheckAliveBots = ReCheckAliveBots
...
config.ForceUseOfTraditionalNametags = ForceUseOfTraditionalNametags
